...
# 체인 생성 (Rerank가 적용된 리트리버 사용)
try:
    combine_docs_chain = create_stuff_documents_chain(llm, prompt)
    chain = create_retrieval_chain(rerank_retriever, combine_docs_chain)
    print("체인 생성 완료.")
except Exception as e:
